...
name_lookup_pb <- c(
    ...
    "Merino" = "Mikel Merino",
    "O'riley" = "Matt O'Riley",
    "F. Kadioglu" = "Ferdi Kadioglu",
    "Dele Alli" = "Dele Alli",
    "Joe O'Brien" = "Joseph O'Brien",
    "Ünal" = "Enes Ünal",
    "T.Adams" = "Tyler Adams",
    "W. Dennis" = "Will Dennis",
    "Thiago" = "Thiago Alcântara",
    "C. Campbell" = "Cody Campbell",
    "T. Chirewa" = "Tawanda Chirewa",
    "Janoi Donacien" = "Janoi Donacien",
    "Ja. Clarke" = "Jack Clarke",
    "D. O'shea" = "John O'Shea",
    "C. Ogbene" = "Chiedozie Ogbene",
    "Berge" = "Sander Berge",
    "L. Bogarde" = "Lamare Bogarde",
    "B. El Khannous" = "Bilal El Khannous",
    "Ben Knight" = "Ben Knight",
    "Gündogan" = "İlkay Gündoğan",
